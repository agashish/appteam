...
(function($, window, document) {
  ...
  */
  ...
  EmojiArea.createIcon = function(emoji, menu) {
	...
	//alert($.emojiarea.spriteSheetPath + ' =='+$.emojiarea.assetsPath );

	//var filename = $.emojiarea.spriteSheetPath ? $.emojiarea.spriteSheetPath : $.emojiarea.assetsPath + 'emoji_spritesheet_!.png';
	//var filename = $.emojiarea.blankGifPath ? $.emojiarea.blankGifPath : $.emojiarea.assetsPath + '/emoji_spritesheet_0.png';
    //var blankGifPath = $.emojiarea.blankGifPath ? $.emojiarea.blankGifPath : $.emojiarea.assetsPath + '/blank.gif';
	
	console.log(window.location.host);
			
	if (window.location.host === "localhost" || location.hostname === "127.0.0.1")
	{
		var originUrl = window.location.origin;	
		var filename = originUrl + '/myteam/lib/img/' + 'emoji_spritesheet_!.png';
    	var blankGifPath = originUrl + '/myteam/lib/img/' + '/blank.gif';
	}
	else
	{
		var originUrl = window.location.origin;	
